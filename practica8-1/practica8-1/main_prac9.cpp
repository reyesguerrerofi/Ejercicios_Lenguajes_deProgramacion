...
CFiguras fig8; //Se crea el tronco
CFiguras fig9; //Se crea el arbol
CFiguras fig10; //Regalos
CFiguras fig11; //Esferas
...
void InitGL ( GLvoid )     // Inicializamos parametros
{
	...
	text7.LoadTGA("city/maderita1.tga");
...
void display ( void )   // Creamos la funcion donde se dibuja
{
	...
	glPushMatrix();
		...
		glPushMatrix();		
			...
			glPushMatrix(); //Tronco
			glDisable(GL_LIGHTING);
			fig8.cilindro(1, 5, 15, text7.GLindex);
			glEnable(GL_LIGHTING);
			glPopMatrix();
			glPushMatrix(); //Follaje
			glTranslatef(0, 5, 0);
			glDisable(GL_LIGHTING);
			fig9.cono(6, 2, 30, text7.GLindex);
			glEnable(GL_LIGHTING);
			glPopMatrix();
